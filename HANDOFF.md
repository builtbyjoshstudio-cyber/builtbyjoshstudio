...
- **NEXT (waiting on Josh's numbers):** Guided planners ($14.99–16.99 paperback / $7.99 Etsy PDF). Workbooks + zodiac DONE (above). The $44 Starter/Money bundles + $57 three-pack are **DISCONTINUED** (Josh, 2026-07-09; zero site references — was a stale memory entry, now corrected). `brand_business.md` memory is flagged repricing-in-progress — verify live prices, don't trust the note.
