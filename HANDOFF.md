...
- **Branch tip `678383d` — 21 commits ahead of `main`. ENTIRE SITE CONVERTED + dark-zodiac iteration; ONLY the live flip remains (await Josh's explicit go).** Working tree clean. **NEVER push without Josh's explicit go; one live flip = Phase 4.**
