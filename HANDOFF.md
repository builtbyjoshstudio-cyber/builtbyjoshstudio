...
- **NEXT (waiting on Josh's numbers):** Guided planners ($14.99–16.99 paperback / $7.99 Etsy PDF) and the **$44 Creator Starter/Money bundles** (in brand memory but NOT found as live pages — confirm they exist). Workbooks + zodiac DONE (above). `brand_business.md` memory is flagged repricing-in-progress — verify live prices, don't trust the note.
