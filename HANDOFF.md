...
- **NEXT (waiting on Josh's numbers):** workbooks (Ultimate Budget / Home Buying, currently $34.99), Guided planners ($14.99–16.99 paperback / $7.99 Etsy PDF), zodiac art, and the **$44 Creator Starter/Money bundles** (in brand memory but NOT found as live pages — confirm they exist). `brand_business.md` memory is flagged repricing-in-progress — verify live prices, don't trust the note.
